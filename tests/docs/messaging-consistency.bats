...
# Load the 26 registry names into the REGISTRY_NAMES array.
load_registry_names() {
...
@test "registry exposes exactly 26 subcommands" {
    load_registry_names
    [ "${#REGISTRY_NAMES[@]}" -eq 26 ]
}
...
@test "section (h) table has exactly 26 data rows" {
